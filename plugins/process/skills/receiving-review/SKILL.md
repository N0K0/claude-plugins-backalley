...
**Principle:** External feedback should be evaluated skeptically but carefully.
...
**Principle:** If the feature isn't needed, don't add it just because a reviewer suggested it.
...
Do not write long apologies, defend why you pushed back, or over-explain. State the correction factually and move on.
